-- Database schema for bilateral-experiment
-- MemGPT core with geometric analysis hooks
...
CREATE TABLE IF NOT EXISTS conversation_history (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    agent_id UUID NOT NULL REFERENCES agents(id) ON DELETE CASCADE,
    role VARCHAR(20) NOT NULL CHECK (role IN ('user', 'assistant', 'function', 'system')),
    content TEXT NOT NULL,
...
-- Geometric metrics cache (for Phase 2 integration)
